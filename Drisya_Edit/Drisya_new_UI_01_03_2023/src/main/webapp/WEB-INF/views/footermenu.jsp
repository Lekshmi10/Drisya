...
<head>
    ...
    <title>Drisya | Applications</title>
</head>
<body>
                ...
                <nav class="sidebar-navigation">
                    <ul>
                        ...
                        <li>
                            <a href="./support">
                                <span class="icon">
                                    <svg width="19px" height="19px" class="ionicon" viewBox="0 0 512 512"><title>Document</title><path d="M416 221.25V416a48 48 0 01-48 48H144a48 48 0 01-48-48V96a48 48 0 0148-48h98.75a32 32 0 0122.62 9.37l141.26 141.26a32 32 0 019.37 22.62z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="32"></path><path d="M256 56v120a32 32 0 0032 32h120" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"></path></svg>
                                </span>
                        ...
                        <li>
                            <a href="./footer" class="active">
                                ...
                                <span class="nav-text">Footer Menu</span>
                            </a>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="template-container">
                <div class="template-header">
                    ...
                    <div class="template-ctrl">
                        <a href="#" target="_blank" class="ctrl-btn">View</a>
                        <button class="ctrl-btn">Save & Publish</button>
                    </div>
                    <div class="user-control">
                        <div class="user-head"><!--open-->
                            <img src="./resources/images/avatar-f.jpg" alt="">
                            <div class="user-name">Krishnakumar</div>
                        </div>
                    </div>
                </div>

                <div class="page-container tab-body-homepage active">
                    <div class="template-card">
                        ...
                        <hr>
                        <div class="menu-widget drag-menu-row" id="group-row"></div>
                    </div>
                </div>
            </div>
        </div>
